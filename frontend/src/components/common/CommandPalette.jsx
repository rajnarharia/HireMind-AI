      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-20 px-4">
          ...
          <motion.div 
            ...
            className="glass-card w-full max-w-2xl rounded-2xl shadow-2xl relative z-10 overflow-hidden border border-gray-200 dark:border-white/10"
          >
            <div className="flex items-center px-4 py-3 border-b border-gray-200 dark:border-white/10 bg-white/50 dark:bg-black/20">
            ...
            <div className="max-h-96 overflow-y-auto custom-scrollbar p-2 bg-white/80 dark:bg-[#111827]/80 backdrop-blur-xl">
